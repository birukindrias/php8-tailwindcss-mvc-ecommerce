...
class View
{
   ...
   <input name="' . $name . '" type="file" placeholder="image" class="bordder-[#E9EDF4] w-full rounded-md border bg-[#FCFDFE] py-3 px-5 text-base text-body-color placeholder-[#ACB6BE] outline-none focus:border-primary focus-visible:shadow-none" />
            ...
            case 'button_':
                echo '
                <div class="mb-10">
                    <input type="submit" value="' . $name . '" name="submit" class="bordder-primary w-full cursor-pointer rounded-md border bg-blue-500 py-3 px-5 text-base text-white transition hover:bg-opacity-90" />
                </div>';
                break;
            case 'box':
                echo '
